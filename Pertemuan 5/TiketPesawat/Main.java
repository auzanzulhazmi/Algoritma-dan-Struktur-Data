...
public class Main {
     public static void main(String[] args) {
        ...
        for(int i=0; i<jmlTiket; i++){
            System.out.println("================================================");
            System.out.println("        DATA TIKET PESAWAT MASKAPAI");
            System.out.println("================================================");
        ...
        System.out.println("======================================================");
        System.out.println("       HARGA TIKET PESAWAT MASKAPAI PENERBANGAN");
        System.out.println("======================================================");
        data.tampil();
        
        System.out.println();
        System.out.println("======================================================");
        System.out.println("             HARGA TIKET SECARA BUBBLE SORT");
        System.out.println("======================================================");
        data.bubbleSort();
        data.tampil();
        ...
        System.out.println();
        System.out.println("======================================================");
        System.out.println("           HARGA TIKET SECARA SELESCTION SORT");
        System.out.println("======================================================");
        data.selectionSort();
        data.tampil();
    }
